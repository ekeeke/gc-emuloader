...
BUILD		:=	build
SOURCES		:=	sources 
INCLUDES	:=	sources sources/lzma/include
...
CFLAGS  = -g -O2 -Wall $(MACHDEP) $(INCLUDE) -meabi \
           -D_LZMA_IN_CB=1 -D_SZ_ONE_DIRECTORY=1 -D_SZ_NO_INT_64=0
...
#---------------------------------------------------------------------------------
LIBS	:=	-logc -lm -logcsys -lz -L./ -llzma
...
$(BUILD):
	@[ -d $@ ] || mkdir $@
	@cd sources/lzma && $(MAKE)
	@make --no-print-directory -C $(BUILD) -f $(CURDIR)/Makefile

#---------------------------------------------------------------------------------
clean:
	@echo clean ...
	@cd sources/lzma && $(MAKE) clean
	@rm -fr $(BUILD) *.elf
